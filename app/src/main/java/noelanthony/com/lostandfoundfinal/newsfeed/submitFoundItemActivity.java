            ...
            public void onClick(DialogInterface dialog, int which) {
               ...
               // matcherItem.child("itemName").setValue(itemName);
                ...
                if(mUploadTask!=null && mUploadTask.isInProgress()){
                    Toast.makeText(submitFoundItemActivity.this, "Upload in progress", Toast.LENGTH_LONG).show();
                    ...
                    Task<Uri>  urlTask = mUploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(submitFoundItemActivity.this, "Upload successful", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(submitFoundItemActivity.this, "Upload Failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    ...
                    mUploadTask = fileReference.putFile(mImageUri)
                            .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    //tasksnapshop.getdownloaduri
                                    item.child("imageID").setValue(mStorageRef.getDownloadUrl().toString());
